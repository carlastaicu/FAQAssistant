...
fake_users_db = {
    "johndoe": {
        ...
        "hashed_password": "$2b$12$di/hJeHpi9cd6LuXPFDpQu15BL1D.KOph0xfIbwmHrXpQEhZJKPiC",
        "disabled": False,
    },
    "alice": {
        "username": "alice",
        ...
        "hashed_password": "$2b$12$R42YHkbVBsQIRMqkyufmZOik3UBY0P5XzoPI4BwC0gRh81zOm3nSy",
        "disabled": True,
    },
}